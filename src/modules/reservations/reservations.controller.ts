...
export class ReservationController {
  ...
  public getResegetReservationsByIdentificationCardrvationBy(
    @Param('identificationCard') identificationCard: string,
  ): Promise<ReservationResponseDto[]> {
    return this.ReservationsService.getReservationsByIdentificationCard(
      identificationCard,
    );
  }
