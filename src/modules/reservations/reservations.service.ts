...
export class ReservationsService {
  ...
  public async createReservation(
    ...
    try {
      ...
      reservationEntity = await this.ReservationRepository.save(
        reservationEntity,
      );
   ...
   */
  public async getReservationsByIdentificationCard(
    ...
    try {
      ...
      return await Promise.all(reservations.map(ReservationMapper.toDto));
    } catch (error) {
